                    ...
                    <div className="p-8 space-y-6">
                        ...
                        <div className="p-4 bg-amber-950/10 border border-amber-900/30 rounded-lg">
                            <p className="text-amber-500 text-xs leading-relaxed">
                                ...
                                Se "found" for falso, o seu UUID de sessão atual não existe na tabela `saas_users`.
                                Isso acontece se você deletou e recriou sua conta, ou se estamos em um projeto diferente do Supabase.
                            </p>
                        </div>
                    </div>
